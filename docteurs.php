...
//$requete = "SELECT * FROM rendez_vous JOIN patient ON rendez_vous.id_patient = patient.id_patient JOIN  diagnostic ON rendez_vous.id_rend=diagnostic.id_rend WHERE diagnostic.id_doc=$id_doc";
