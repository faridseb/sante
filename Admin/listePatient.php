        ...
        <div class="container">
            ...
            <table>
                ...
                <?php foreach($utilisateurs as $utilisateur) { ?>
                    <tr>
                    <td><?=$utilisateur['nom_patient']?></td>
                    <td><?=$utilisateur['prenom_patient']?></td>
                    <td><?=$utilisateur['sexe']?></td>
                    <td><?=$utilisateur['email']?></td>
                    <td style="font-size:25px;"><a style="color:black;" href="deletePat.php?id=<?= $utilisateur['id_patient']?>"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                <?php } ?>
